...
export default function PayPage() {
  ...
  const Fetchpayment = async (id) => {
    const response = await fetch(
      `https://stableflow.onrender.com/payment/${id}`,
      {
        method: 'GET',
      }
    );
    ...
    <div className='flex items-center justify-center flex-col lg:gap-[3rem] gap-[2rem] mt-[2rem] '>
      ...
      <div className='grid gap-[2rem] '>
        ...
        <div className='flex items-center gap-[1rem] justify-center'>
          ...
          <h3 className=' text-[16px] text-primary2 font-[700]'>{descript}</h3>
        </div>
        <div className='flex items-center gap-[1rem] justify-center'>
          <h3 className='text-[18px] font-[700] text-primary1'>
            Amount in USDC :
        ...
        <div className='flex items-center gap-[1rem] justify-center'>
          ...
          <h3 className=' text-[16px] text-primary2 font-[700]'>N{amount2}</h3>
        </div>
      </div>
