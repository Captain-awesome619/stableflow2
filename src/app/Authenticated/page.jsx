...
import { setMybuisnessname, setProfileId } from '@/store';
...
const Page = () => {
  ...
  const validationSchema = yup.object().shape({
    myField: yup.string().required('This field is required'),
  });
  ...
  return (
    <div className=' grid items-center justify-center'>
      <div className='flex items-center justify-center mt-[2rem]'>
        <Image src={logo} width={200} height={200} alt='model' className='' />
      </div>
      {loading === 1 ? (
            ...
            {({ isValid }) => (
              <Form className='grid gap-[2rem] w-screen items-center justify-center'>
                ...
                <div className='flex flex-col gap-[1rem]'>
                  ...
                  <div>
                    <Field
                      ...
                      className='pl-[0.5rem] h-[60px] w-[400px] border-[2px] rounded-xl border-primary3'
                    />
                  </div>
                  {!isValid && (
                    <ErrorMessage
                ...
                <button
                  className={
                    name
                      ? 'bg-primary5 duration-300  w-[200px]  flex items-center justify-center h-[50px] cursor-pointer  py-2 rounded-xl text-white'
                      : ' duration-300  bg-primary5 w-[200px]  opacity-[0.2] flex items-center justify-center h-[50px] cursor-not-allowed  py-2 rounded-xl text-white'
                  }
                  type='submit'
                  disabled={!name}
      ...
      {loading === 2 ? (
        <div>
          ...
          <div
            className={
              redirect === true
                ? 'opacity-[0.2] flex flex-col gap-[2rem] mt-[4rem] items-center justify-center'
                : 'flex flex-col gap-[2rem] mt-[4rem] items-center justify-center'
            }
          >
            <Image
              src={whistle}
